...
@click.option('--ssh-user', default='ec2-user')
...
def cli(num_locales, instance_name, key_pair_name, key_pair_key, ssh_user, chapel_exe, chapel_args):
    ...
    launchable_instances = ec2.copy_to_instances(chapel_exe, instances, key_pair_name, key_pair_key, ssh_user)
    ec2.run_on_instances(launchable_instances, chapel_exe, chapel_args, key_pair_name, key_pair_key, ssh_user)
